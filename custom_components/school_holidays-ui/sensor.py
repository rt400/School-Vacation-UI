"""
Sensor platform for Israel School Holidays UI integration.

Creates a sensor entity that provides a summary of School Holidays UI
...
async def async_setup_entry(
    ...
    """
    Set up the Israel School Holidays UI sensor platform.
...
class SchoolHolidaysSensor(CoordinatorEntity, SensorEntity):
    """Representation of a School Holidays UI summary sensor."""
