...
2. Extract the files to your `custom_components/school_holidays_ui/` directory
...
[https://github.com/rt400/School-Vacation/blob/master/data.json](https://github.com/rt400/School-Vacation-UI/blob/master/data.json)
