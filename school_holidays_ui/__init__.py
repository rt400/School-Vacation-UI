"""
Israel School Holidays UI integration for Home Assistant.
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """
    Set up the Israel School Holidays UI integration from a config entry.
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """
    Unload the Israel School Holidays UI integration.
...
async def async_reload_entry(hass: HomeAssistant, entry: ConfigEntry) -> None:
    """
    Reload the Israel School Holidays UI integration.
