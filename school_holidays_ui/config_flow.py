"""
Config flow for Israel School Holidays UI integration.

Handles the configuration and options flow for the Israel School Holidays UI
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Israel School Holidays UI integration."""
    ...
    async def async_step_user(
        ...
        return self.async_create_entry(title="Israel School Holidays UI", data=user_input)
...
class OptionsFlowHandler(config_entries.OptionsFlow):
    """Handle options flow for Israel School Holidays UI integration."""
